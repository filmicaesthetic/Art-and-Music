...
whole_song_long %>%
  ...
  geom_point(aes(size = n, color = notes), alpha = 0.35, shape = 1, stroke = 3) +
  ...
  theme(legend.position = "bottom",
        ...
        axis.title.y = element_text(face = "bold", size = 30, color = "#6c3b4d", hjust = 0.72),
        plot.title = element_text(hjust = 0.5, size = 65),
        plot.subtitle = element_text(hjust = 0.5, size = 40),
        legend.title = element_text(face = "bold", size = 30, color = "#6c3b4d", hjust = 0.72))
